...
{{/* Sélecteur minimal stable : name + instance uniquement (pas managed-by,
     ni part-of — le selector d'un Deployment est immuable, on n'y met que
     ce qui ne bougera jamais). */}}
